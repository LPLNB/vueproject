...
//   "error" 或 2 - 开启规则，使用错误级别的错误：error (当被触发的时候，程序会退出)
  ...
  "semi": [2, 'never',{"beforeStatementContinuationChars": "any"}], // ??? 强制是否使用分号。"never" 禁止在语句末尾使用分号 (除了消除以 [、(、/、+ 或 - 开始的语句的歧义)
  ...
  "semi-style": [2, "last"], // 分号风格
  "space-before-blocks": [2, 'always'], // 禁止语句块之前的空格
  "space-before-function-paren": [2, 'always'], // 禁止函数圆括号之前有一个空格
